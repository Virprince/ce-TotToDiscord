import { 
   ...
   */
  function parseRRAbilityUse(params: string): RRAbilityUseParams | null {
   ...
   */
  function parseFlowChartLog(params: string): FlowChartLogParams {
   ...
   */
  export function parseParams(eventId: string, params: string): ParsedParams | null {
